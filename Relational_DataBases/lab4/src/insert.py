...
def fill_database_generate_data(db, count):
    ...
    new_worker_educations = generate_worker_educations(new_workers, new_educations)
    ...
    new_worker_workbooks = generate_worker_workbooks(count, new_workers, new_workbooks)
    ...
    new_workbook_employer_writings = generate_workbook_employer_writings(new_workbook_writings, new_workbooks, new_employers)
    ...
    new_vacancy_requirements = generate_vacancy_requirements(new_requirements, new_vacancies)
    ...
    new_vacancy_conditions = generate_vacancy_conditions(new_conditions, new_vacancies)
